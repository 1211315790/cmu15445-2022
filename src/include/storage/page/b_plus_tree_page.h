...
class BPlusTreePage {
 ...
 private:
  ...
  IndexPageType page_type_ __attribute__((__unused__));  // leaf or internal. 4 Byte
  lsn_t lsn_ __attribute__((__unused__));
  int size_ __attribute__((__unused__));      // 关键字个数=size_-1
  int max_size_ __attribute__((__unused__));  // M
